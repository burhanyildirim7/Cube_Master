...
public class GameController : MonoBehaviour
{
    ...
    [HideInInspector] public bool _hareketiDurdur;
    ...
    {
        isContinue = false;
        _hareketiDurdur = false;
    }


    /// <summary>
    /// Bu fonksiyon ge�erli leveldeki scoreu belirtilen miktarda artirir veya azaltir. Artirma icin +5 gibi pozitif eksiltme
    ...
    /// <summary>
    /// Bu fonksiyon ge�erli leveldeki elmasi belirtilen miktarda artirir veya azaltir. Artirma icin +5 gibi pozitif eksiltme
    /// icin -5 gibi negatif deger girin.
    /// </summary>
    ...
    public void ScoreCarp(float katsayi)
    {
        if (PlayerController.instance.xVarMi) score = (int)(score * katsayi);
        else score = 1 * score;
